...
public class JavamonBattle {
  public static void battle(Javamon j1, Javamon j2, Scanner in) {
  ...
  public static void main(String[] args) {
    ...
    Javamon j1 = new Javamon(input.nextLine());
    ...
    Javamon j2 = new Javamon(input.nextLine());
